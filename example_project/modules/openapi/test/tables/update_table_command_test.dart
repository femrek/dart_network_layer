...
/// tests for TablesUpdateTableApi
void main() {
  // final instance = TablesUpdateTableApi();

  group('tests for TablesUpdateTableApi', () {
    ...
    //
    //Future<Table> updateTable(int id, Map<String, Object> requestBody) async
